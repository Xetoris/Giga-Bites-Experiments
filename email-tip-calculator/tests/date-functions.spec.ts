...
describe('Date Functions', () => {
    describe('Relative Previous Date', () => {
        it('can return a date in the past', () => {
            let testAnchorDate = new Date('12/12/2021');
            let previousDate = getRelativePreviousDate(testAnchorDate, 1);
    ...
    describe('Relative Future Date', () => {
        it('can return a date in the future', () => {
            let testAnchorDate = new Date('12/12/2021');
            let previousDate = getRelativeFutureDate(testAnchorDate, 1);
    ...
    describe('Query Formatted String', () => {
        it('can return a formatted string', () => {
            let testAnchorDate = new Date('12/12/2021');
            let formattedString = getQueryFormattedString(testAnchorDate);
